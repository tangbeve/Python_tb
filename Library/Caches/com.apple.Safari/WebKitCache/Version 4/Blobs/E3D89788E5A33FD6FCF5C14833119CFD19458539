...
g.kd(c,g.me("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"));var d=window.document.getElementsByTagName("head")[0]||window.document.body;d.insertBefore(c,d.firstChild);return c},wDa=function(){var a=uDa(),b=window.document.getElementById(a),c=b&&g.oF(b,"loaded");
...
a.Bd&&(c=null);var d=(0,g.B)(a.CX,a);c||(c=new g.Im("//www.google.com/images/cleardot.gif"),i6(c));LDa(c.toString(),1E4,d)}else K6(2);bEa(a,b)},bEa=function(a,b){a.o=0;
